...
drop = 0.5; #drop fro.5m the DropOut layer, optimal between 0.2 to 0.5
optimizer = 'sgd' # other possible options are: 'sgd' (stochastic gradient descent) etc..
optimizerdict = {'learning_rate': lr}
train,retrain,applynet = (True,False,False)
...
fig = plt.matshow(np.random.random((168,168)))
...
if train:
    ...
    #print(model.score(val_iter,eval_metric='acc'))
...
if applynet:
    ...
    fe_sym = all_layers['target_output'] # ->  OUTPUT function
